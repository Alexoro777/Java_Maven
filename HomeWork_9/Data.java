...
public class Data {
    ...
    public static List<Student> getStudentsList() {
        ...
        Course course1 = new Course("Компьютерные сети");
        Course course2 = new Course("Тестирование мобильных приложений");
    ...
    private static List<Course> getListCourses() {
        return Arrays.asList(new Course("Компьютерные сети"),
